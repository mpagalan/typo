...
describe Feedback, 'on named_scopes ' do
  before(:each) do
  ...
  describe '#most_recent' do
    it "should return all feedbacks ordered by most recent" do
      Feedback.most_recent == [@spam_comment, @published_comment, @published_trackback, @unconfirmed_trackback, @uncofirmed_comment]
    end
  end
  ...
  describe '#hams' do
    it "should return all ham feedbacks" do
      Feedback.hams.should == [@published_comment, @published_trackback]
    end
  end
  ...
  describe '#search' do 
    ...
    it "should return feedbacks with simillar email of eg: 'emil_stewart@example.com'" do
